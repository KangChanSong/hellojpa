...
public class QCategory extends EntityPathBase<Category> {
    ...
    public final ListPath<com.example.jpashop.domain.item.Item, com.example.jpashop.domain.item.QItem> items = this.<com.example.jpashop.domain.item.Item, com.example.jpashop.domain.item.QItem>createList("items", com.example.jpashop.domain.item.Item.class, com.example.jpashop.domain.item.QItem.class, PathInits.DIRECT2);
